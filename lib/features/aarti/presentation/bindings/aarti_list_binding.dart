...
import 'package:bhakti_vibe/features/aarti/presentation/controllers/aarti_list_controller.dart';
import 'package:get/instance_manager.dart';

class AartiListBinding extends Bindings {
  @override
  void dependencies() {
    ...
    Get.lazyPut<AartiListController>(
      () => AartiListController(
